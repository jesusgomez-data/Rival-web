...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.groq.com https://api.stripe.com https://api.resend.com https://cdn.jsdelivr.net https://*.ingest.de.sentry.io https://*.ingest.sentry.io https://*.sentry.io https://challenges.cloudflare.com",
