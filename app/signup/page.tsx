            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 pt-24 lg:pt-8 relative order-1 min-h-screen lg:min-h-0">
                ...
                <div className="max-w-md w-full">
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center gap-2 py-3 border border-border rounded-xl hover:bg-foreground/5 transition-all font-bold">
                        ...
                        <div className="mt-8 text-center border-t border-border pt-6">
                            <p className="text-muted-foreground text-sm">¿Ya tienes cuenta? <Link href="/login" className="text-brand-red font-bold hover:underline">Inicia Sesión</Link></p>
                        </div>
                    </div>
                </div>
            </div>
