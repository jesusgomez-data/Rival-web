...
import { MessageCircle, Share2, MoreHorizontal, Send, Trash2, X, Building2, Dumbbell, Zap, Flame, TrendingUp, ChevronDown, Plus, Play, Clock, ArrowRight } from "lucide-react";
        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden mb-8 animate-fade-in shadow-lg" ref={postRef}>
            ...
            <div className="px-4 py-3 bg-muted/20 border-t border-border">
                ...
                <div className="flex items-center gap-2 border-t border-border pt-3">
                    ...
                    >
                        <LikeFist active={isLiked} size={20} />
                        Like
                    </button>
                    <button
            ...
            {showWODTracker && (
                <WODTrackerModal
                    ...
                    defaultPartner={wodData?.partner || null}
