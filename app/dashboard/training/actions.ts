...
export async function getExercises(sport: string | null | undefined = 'gym') {
    ...
    const ocrExercises = [
        ...
        { name: 'Dead Hang', muscle_group: 'Grip', video_url: 'https://www.youtube.com/watch?v=vV_Xn7_X_Xw' },
        { name: 'Monkey Bars', muscle_group: 'Grip', video_url: 'https://www.youtube.com/watch?v=9_p_p_p_p_p' }, // Fallback for specialized
        { name: 'Wall Climb', muscle_group: 'Full Body', video_url: 'https://www.youtube.com/watch?v=Xn7_v9pQEqc' },
        { name: 'Spear Throw', muscle_group: 'Skill', video_url: 'https://www.youtube.com/watch?v=7uI6vjE7q6U' },
        { name: 'Sandbag Carry', muscle_group: 'Legs/Core', video_url: 'https://www.youtube.com/watch?v=Xn7_v9pQEqc' },
        ...
        { name: 'Log Carry', muscle_group: 'Strongman', video_url: 'https://www.youtube.com/watch?v=Xn7_v9pQEqc' },
        ...
        { name: 'Sandbag Lunges', muscle_group: 'Legs', video_url: 'https://www.youtube.com/watch?v=N_8qP_v_v_v' },
        { name: 'Barbed Wire Crawl', muscle_group: 'Full Body', video_url: 'https://www.youtube.com/watch?v=z8o0d-n-n-n' },
        { name: 'Hercules Hoist', muscle_group: 'Back/Grip', video_url: 'https://www.youtube.com/watch?v=vV_Xn7_X_Xw' },
