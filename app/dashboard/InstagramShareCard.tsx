        ...
        <div className="fixed inset-0 z-[320] bg-black/98 flex flex-col items-center justify-start overflow-y-auto p-4 md:p-8 backdrop-blur-3xl animate-in fade-in duration-500 custom-scrollbar">
            ...
            <div className="w-full max-w-sm flex justify-between items-center mb-10 shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-white/40 text-[9px] font-black uppercase tracking-[0.4em]">PERFORMANCE EDITOR</p>
                </div>
                <button
                    onClick={onClose}
            ...
            <div className="flex flex-col items-center gap-6 w-full max-w-sm pb-16">
                ...
                <div className="relative shadow-[0_0_100px_rgba(255,46,46,0.15)] rounded-[48px] overflow-hidden border border-white/10 transition-transform origin-top scale-90 sm:scale-100">
                    <div
                        ref={cardRef}
                        className="w-[360px] h-[640px] bg-[#050505] relative overflow-hidden flex flex-col items-center justify-between py-12 px-8 font-sans"
                    >
